...
def welcome():
    return [os.environ.get("MYSQL_USER"), os.environ.get("MYSQL_HOST"),os.environ.get("MYSQL_PASSWORD"), os.environ.get("MYSQL_PORT"), os.environ.get("MYSQL_PASSWORD"), os.environ.get("MYSQL_DB")]
...
def add_to_table():
    if request.is_json:
        ...
        try:
            cur = mysql.connection.cursor()
            cur.execute("INSERT INTO mytable (id, name, age) VALUES (%s, %s, %s)", (uuid.uuid1(), item['name'], item['age']))
